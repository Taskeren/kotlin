inline fun checkObjectPatterns() {
    ...
    assertEquals(1, js("(function () { ({ a } = { a: 1 }); return a; })()"))
    ...
    assertEquals(1, js("(function () { const { a: { c: d } = { d: 1 } } = { a: { b: 1 } }; return d; })()"))
    assertEquals(2, js("(function () { const {} = { a: 1 }; return 1; })()"))
    assertEquals(2, js("(function () { const { [('a')]: b = 12 } = { a: 1 }; return b; })()"))
...
inline fun checkArrayPatterns() {
    ...
    assertEquals(1, js("(function () { ([a] = [1]); return a; })()"))
    ...
    assertEquals(1, js("(function () { const [[a]] = [[1]]; return a; })()"))
    assertEquals(6, js("(function () { const [[a, b], c] = [[1, 2], 3]; return a + b + c; })()"))
    assertEquals(2, js("(function () { const [] = [1]; return 1; })()"))
    assertEquals(4, js("(function () { const [a, ...b] = [1, 2, 3]; return a + b.length; })()"))
