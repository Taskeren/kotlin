...
// WASM_CHECK_LOCAL_IN_SCOPE: name=iShouldNotBeRenamed scope_function=dontRenameNormal
...
// WASM_CHECK_LOCAL_NOT_IN_SCOPE: name=inductionVariable scope_function=inductionVar
...
// WASM_CHECK_LOCAL_IN_SCOPE: name=explicitLambdaParameter scope_function=lambdas
// WASM_CHECK_LOCAL_IN_SCOPE: name=it scope_function=lambdas
// WASM_CHECK_LOCAL_IN_SCOPE: name=explicitNested scope_function=lambdas
fun lambdas() : Int {
