...
internal class JavaAnnotationConstructor(
    ...
    override val arity: Int get() = caller.arity // TODO: should fail for non-single-value Java annotation, add a test and replace with methods.size
...
internal class JavaAnnotationConstructorParameter(
    ...
    override val type: KType get() = method.genericReturnType.toKType(emptyMap(), TypeNullability.NOT_NULL)
